...
public class PeerListAdapter extends BaseAdapter {
    ...
    PeerListAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (inflater != null) {
            convertView = inflater.inflate(R.layout.peer_entry, parent, false);
            holder.peer = convertView.findViewById(R.id.peer_textview_individual);
